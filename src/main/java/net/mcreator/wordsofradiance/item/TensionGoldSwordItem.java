...
import net.mcreator.wordsofradiance.procedures.TensionGoldSwordItemInHandTickProcedure;

public class TensionGoldSwordItem extends Item {
	public TensionGoldSwordItem(Item.Properties properties) {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			TensionGoldSwordItemInHandTickProcedure.execute(entity);
	}
}
