...
import net.mcreator.wordsofradiance.procedures.TensionWoodenSwordItemInHandTickProcedure;

public class TensionWoodenSwordItem extends Item {
	public TensionWoodenSwordItem(Item.Properties properties) {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			TensionWoodenSwordItemInHandTickProcedure.execute(entity);
	}
}
