...
import net.mcreator.wordsofradiance.procedures.TensionDiamondSwordItemInHandTickProcedure;

public class TensionDiamondSwordItem extends Item {
	public TensionDiamondSwordItem(Item.Properties properties) {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			TensionDiamondSwordItemInHandTickProcedure.execute(entity);
	}
}
