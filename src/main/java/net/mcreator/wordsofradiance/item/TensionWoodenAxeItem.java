...
import net.mcreator.wordsofradiance.procedures.TensionWoodenAxeItemInHandTickProcedure;

public class TensionWoodenAxeItem extends Item {
	public TensionWoodenAxeItem(Item.Properties properties) {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			TensionWoodenAxeItemInHandTickProcedure.execute(entity);
	}
}
