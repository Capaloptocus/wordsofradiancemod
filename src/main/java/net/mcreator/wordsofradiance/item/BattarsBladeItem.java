...
import net.mcreator.wordsofradiance.procedures.BattahBladeRightclickedOnBlockProcedure;

public class BattarsBladeItem extends Item {
	public BattarsBladeItem(Item.Properties properties) {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		BattahBladeRightclickedOnBlockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getLevel().getBlockState(context.getClickedPos()),
