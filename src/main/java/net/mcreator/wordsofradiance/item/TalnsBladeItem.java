...
import net.mcreator.wordsofradiance.procedures.TalenelatBladeRightclickedOnBlockProcedure;
import net.mcreator.wordsofradiance.procedures.BondHonourbladeProcedure;

public class TalnsBladeItem extends Item {
	public TalnsBladeItem(Item.Properties properties) {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		TalenelatBladeRightclickedOnBlockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getLevel().getBlockState(context.getClickedPos()),
