...
import net.mcreator.wordsofradiance.procedures.BreakBondDeadBladeProcedure;

public class BondedDeadBladePinkRedItem extends Item {
	public BondedDeadBladePinkRedItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		BreakBondDeadBladeProcedure.execute(entity, entity.getItemInHand(hand));
		return ar;
	}
