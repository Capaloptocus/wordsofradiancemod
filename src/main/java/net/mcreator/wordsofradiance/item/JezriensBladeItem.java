...
import net.mcreator.wordsofradiance.procedures.JezriensBladeRightclickedOnBlockProcedure;
import net.mcreator.wordsofradiance.procedures.BondHonourbladeProcedure;

public class JezriensBladeItem extends Item {
	public JezriensBladeItem(Item.Properties properties) {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		JezriensBladeRightclickedOnBlockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getLevel().getBlockState(context.getClickedPos()),
