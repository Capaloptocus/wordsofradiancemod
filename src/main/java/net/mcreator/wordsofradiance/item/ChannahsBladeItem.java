...
import net.mcreator.wordsofradiance.procedures.ChannahsBladeRightclickedOnBlockProcedure;
import net.mcreator.wordsofradiance.procedures.BondHonourbladeProcedure;

public class ChannahsBladeItem extends Item {
	public ChannahsBladeItem(Item.Properties properties) {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		ChannahsBladeRightclickedOnBlockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getLevel().getBlockState(context.getClickedPos()),
