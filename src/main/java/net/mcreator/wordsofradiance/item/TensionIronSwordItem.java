...
import net.mcreator.wordsofradiance.procedures.TensionIronSwordItemInHandTickProcedure;

public class TensionIronSwordItem extends Item {
	public TensionIronSwordItem(Item.Properties properties) {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			TensionIronSwordItemInHandTickProcedure.execute(entity);
	}
}
