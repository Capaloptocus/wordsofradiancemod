...
import net.mcreator.wordsofradiance.procedures.TensionStoneSwordItemInHandTickProcedure;

public class TensionStoneSwordItem extends Item {
	public TensionStoneSwordItem(Item.Properties properties) {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			TensionStoneSwordItemInHandTickProcedure.execute(entity);
	}
}
