...
import net.mcreator.wordsofradiance.procedures.TensionStoneAxeItemInHandTickProcedure;

public class TensionStoneAxeItem extends Item {
	public TensionStoneAxeItem(Item.Properties properties) {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			TensionStoneAxeItemInHandTickProcedure.execute(entity);
	}
}
