...
import net.mcreator.wordsofradiance.procedures.TensionGoldAxeItemInHandTickProcedure;

public class TensionGoldAxeItem extends Item {
	public TensionGoldAxeItem(Item.Properties properties) {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			TensionGoldAxeItemInHandTickProcedure.execute(entity);
	}
}
