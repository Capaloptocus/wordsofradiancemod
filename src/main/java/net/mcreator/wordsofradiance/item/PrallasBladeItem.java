...
import net.mcreator.wordsofradiance.procedures.PrallahsBladeRightclickedOnBlockProcedure;
import net.mcreator.wordsofradiance.procedures.BondHonourbladeProcedure;

public class PrallasBladeItem extends Item {
	public PrallasBladeItem(Item.Properties properties) {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		PrallahsBladeRightclickedOnBlockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getLevel().getBlockState(context.getClickedPos()),
