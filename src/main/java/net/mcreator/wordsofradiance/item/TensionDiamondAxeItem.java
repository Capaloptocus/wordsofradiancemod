...
import net.mcreator.wordsofradiance.procedures.TensionDiamondAxeItemInHandTickProcedure;

public class TensionDiamondAxeItem extends Item {
	public TensionDiamondAxeItem(Item.Properties properties) {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			TensionDiamondAxeItemInHandTickProcedure.execute(entity);
	}
}
