...
import net.mcreator.wordsofradiance.procedures.NalesBladeRightclickedOnBlockProcedure;
import net.mcreator.wordsofradiance.procedures.BondHonourbladeProcedure;

public class NalesBladeItem extends Item {
	public NalesBladeItem(Item.Properties properties) {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		NalesBladeRightclickedOnBlockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getLevel().getBlockState(context.getClickedPos()), context.getPlayer(),
