...
import net.mcreator.wordsofradiance.procedures.TensionIronAxeItemInHandTickProcedure;

public class TensionIronAxeItem extends Item {
	public TensionIronAxeItem(Item.Properties properties) {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			TensionIronAxeItemInHandTickProcedure.execute(entity);
	}
}
