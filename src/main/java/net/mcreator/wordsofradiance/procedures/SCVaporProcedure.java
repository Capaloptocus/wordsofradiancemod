...
public class SCVaporProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
			...
			_player.closeContainer();
		{
			...
			_vars.SoulcastingBlockSet = (Blocks.AIR.asItem() instanceof BlockItem _bi ? _bi.getBlock().defaultBlockState() : Blocks.AIR.defaultBlockState());
