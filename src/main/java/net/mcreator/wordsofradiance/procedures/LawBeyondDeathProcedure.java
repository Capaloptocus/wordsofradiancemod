...
public class LawBeyondDeathProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		{
			WordsOfRadianceModVariables.PlayerVariables _vars = entity.getData(WordsOfRadianceModVariables.PLAYER_VARIABLES);
			_vars.IdealOfDedicationVariable = "lawBeyondDeath";
			_vars.syncPlayerVariables(entity);
		}
		if (entity instanceof Player _player) {
			ItemStack _setstack = new ItemStack(WordsOfRadianceModItems.DEDICATION_BEYOND_DEATH_BOOK.get()).copy();
