...
public class LawOfConquestProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		{
			WordsOfRadianceModVariables.PlayerVariables _vars = entity.getData(WordsOfRadianceModVariables.PLAYER_VARIABLES);
			_vars.IdealOfDedicationVariable = "lawOfConquest";
			_vars.syncPlayerVariables(entity);
		}
		if (entity instanceof Player _player) {
			ItemStack _setstack = new ItemStack(WordsOfRadianceModItems.DEDICATION_CONQUEST_BOOK.get()).copy();
