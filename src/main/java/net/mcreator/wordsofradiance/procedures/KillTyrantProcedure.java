...
public class KillTyrantProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		{
			WordsOfRadianceModVariables.PlayerVariables _vars = entity.getData(WordsOfRadianceModVariables.PLAYER_VARIABLES);
			_vars.IdealOfCrusadeVariable = "killTyrant";
			_vars.syncPlayerVariables(entity);
		}
		if (entity instanceof Player _player) {
			ItemStack _setstack = new ItemStack(WordsOfRadianceModItems.CRUSADE_TYRANT_BOOK.get()).copy();
