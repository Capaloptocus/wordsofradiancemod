...
public class SCTalusProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
			...
			_player.closeContainer();
		{
			...
			_vars.SoulcastingBlockSet = (Blocks.STONE.asItem() instanceof BlockItem _bi ? _bi.getBlock().defaultBlockState() : Blocks.AIR.defaultBlockState());
