...
public class TensionDiamondShovelItemInHandTickProcedure {
	public static void execute(Entity entity) {
		...
		if (!((entity instanceof Player _plr ? _plr.getFoodData().getFoodLevel() : 0) > 0 && entity instanceof LivingEntity _livEnt1 && _livEnt1.hasEffect(WordsOfRadianceModMobEffects.TENSION_SURGE))) {
			...
			if (entity instanceof Player _player)
				_player.getFoodData().setFoodLevel((int) (entity.getData(WordsOfRadianceModVariables.PLAYER_VARIABLES).radiantTickCount - 0.1));
		}
	}
}
