...
public class SCFoilProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
			...
			_player.closeContainer();
		{
			...
			_vars.SoulcastingBlockSet = (Blocks.IRON_BLOCK.asItem() instanceof BlockItem _bi ? _bi.getBlock().defaultBlockState() : Blocks.AIR.defaultBlockState());
