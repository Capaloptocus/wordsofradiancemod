...
public class LawOfOccupationProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		{
			WordsOfRadianceModVariables.PlayerVariables _vars = entity.getData(WordsOfRadianceModVariables.PLAYER_VARIABLES);
			_vars.IdealOfDedicationVariable = "lawOfOccupation";
			_vars.syncPlayerVariables(entity);
		}
		if (entity instanceof Player _player) {
			ItemStack _setstack = new ItemStack(WordsOfRadianceModItems.DEDICATION_OCCUPATION_BOOK.get()).copy();
